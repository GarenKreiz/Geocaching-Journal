...
if __name__ == '__main__':
    def usage():
        ...
        print('       contenu de tous les logs avec reférences aux images')
        print('   logbook.html')
        ...
        print('       commence le traîtement des logs à partir de la date startDate incluse (format AAAA/MM/JJ)')
        print('   -e|--end endDate')
        print('       stop processing log after date endDate (format YYYY/MM/DD)')
        print('       arrête le traîtement des logs après la date endDate (format AAAA/MM/JJ)')
        print('   -r|--refresh')
